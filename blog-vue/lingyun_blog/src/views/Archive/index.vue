<template>
    <div class="page-header">
        ...
        <img class="page-cover" src="https://static.galaxylingyun.top/resource/article.jpg"
            alt="">
        <!-- 波浪 -->
        <Waves></Waves>
    </div>
    <div class="bg">
        <div class="page-container">
            ...
            <Pagination v-if="count > 0" v-model:current="queryParams.current" :total="Math.ceil(count / 5)"></Pagination>
        </div>
    </div>
</template>
