<template>
    ...
    <div class="message-container">
        ...
        <div class="message-input">
            ...
            &nbsp;&nbsp;<button class="send" @click="send" v-show="show"><svg-icon icon-class="fire" size="1.2rem"></svg-icon>发射</button>
        </div>
    </div>
    <!-- 弹幕列表 -->
...
.danmaku-container {
    ...
    background-image: url("https://static.galaxylingyun.top/resource/message.jpg");
