<template>
    <div class="app-container">
        ...
        <div class="operation-container">
            标题<el-input v-model="articleForm.articleTitle" placeholder="请输入文章标题"></el-input>
            <el-button type="primary" style="margin-left: 10px" @click="openModel">发布文章</el-button>
        </div>
        <!-- 文章内容 -->
        ...
        <el-dialog title="发布文章" v-model="addOrUpdate" width="600px" top="0.5vh" append-to-body>
            ...
            <template #footer>
                <div class="dialog-footer">
                    <el-button v-if="articleForm.status != 3" type="success" @click="submitForm">发布文章</el-button>
