<template>
    <div class="menu">
        <div class="menu-item title">
            ...
            <router-link to="/" class="menu-btn">
                <img src="https://static.galaxylingyun.top/resource/logo.png" height="46"  width="105">
            </router-link>
        </div>
        ...
        <div class="menu-item dropdown">
            <a class="menu-btn drop">
                <svg-icon icon-class="fun"></svg-icon> 动态
            </a>
            <ul class="submenu">
        ...
        <div class="menu-item" :class="{ active: route.meta.title === '留言' }">
            <router-link to="/message" class="menu-btn">
                <svg-icon icon-class="message"></svg-icon> 树洞
            </router-link>
        </div>
...
.submenu .subitem:hover {
    color: var(--grey-0);
    background-image: linear-gradient(to right, var(--color-blue) 0, var(--color-aqua) 100%);
